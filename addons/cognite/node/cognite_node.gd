...
var runtime_context: Array[CogniteRuntimeContext]
...
func _enter_tree() -> void:
	...
	for context_id in cognite_assemble.contexts:
		runtime_context.append(CogniteRuntimeContext.new(cognite_assemble.contexts[context_id], cognite_assemble, self))
